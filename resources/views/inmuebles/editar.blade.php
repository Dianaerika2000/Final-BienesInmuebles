...
@section('content')
    ...
    <section class="section">
        <div class="section-header" style="background-color: {{ auth()->user()->color}}">
            <h3 class="page__heading">Editar Inmueble</h3>
        </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-sm-11 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <input type="text" id="codigo" name="codigo" value = "{{$inmueble->codigo}}" required="required" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-sm-11 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <input type="number" step='0.01' id="monto" name="monto" value="{{$inmueble->monto}}" required="required" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-sm-6 col-sm-11 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control input-sm" value="{{$inmueble->direccion->ubicacion}}" type="text"
                                                   name="ubicacion" id="searchmap" >
                                        </div>
                                        <div class="form-group">
                                            <label for="lat" id="label2">Latitud: </label>
                                            <input value="{{$inmueble->direccion->latitud}}" type="text"
                                                   class="form-control input-sm"
                                                   name="lat" id="lat">
                                        </div>
                                        <div class="form-group">
                                            <label for="lng" id="label3">Longitud: </label>
                                            <input value="{{$inmueble->direccion->longitud}}" type="text"
                                                   class="form-control input-sm"
                                                   name="lng" id="lng">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input value="{{$inmueble->direccion->descripcion}}" type="text"
                                                   class="form-control input-sm"
