...
{{-- EDIFICIOS - CONSTRUCCIONES COMPLEMENTARIAS --}}
...
<body>
    ...
    <header class="row">
        ...
        <div class="me">
            <p>
                <strong>ACTIVOS FIJO - BIENES INMUEBLES</strong><br>
    ...
    <div class="row section">
        <div class="col-2">
            <h1 contenteditable style="color: #2A3964 !important">BIENES INMUEBLES</h1>
        </div>
        <div class="col-2 details2">
            <p class="client">
                <b>Terreno: {{$codigoB}}</b><br>
                <b>Tipo de inmuebles: {{$tipoBase == "edificios" ? 'Edificios' : 'Construcciones Complementarias'}}</b><br>
    ...
    <script>
        window.jQuery || document.write(
            '<script src="{{ asset('UsuarioFacturar/assets/bower_components/jquery/dist/jquery.min.js') }}"><\/script>'
            )
    </script>
