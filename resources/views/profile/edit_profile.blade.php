                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" name="nombre" id="nombre" class="form-control" required autofocus tabindex="1">
                        </div>
                        <div class="form-group col-sm-6">
                            <label>Apellido:</label><span class="required">*</span>
                            <input type="text" name="apellido" id="apellido" class="form-control" required autofocus tabindex="1">
                        </div>
